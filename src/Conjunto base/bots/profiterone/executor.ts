...
import { FlashloanProvider, DexSwap, BuiltRoute, CallData } from "../../shared/types";
import { executorContractArbitrum } from "../../constants/config";
import { dexSwapToCallData } from "./arbitragebuilder";
...
export async function executeArbitrage({
  ...
  const result = await sendBundle(txs, targetBlock, walletSigner, {
