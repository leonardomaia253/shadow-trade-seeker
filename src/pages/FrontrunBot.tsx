...
const FrontrunBot = () => {
  ...
  useEffect(() => {
    ...
    const statsChannel = supabase
      .channel('frontrun-stats-updates')
      .on('postgres_changes', 
          { event: 'UPDATE', schema: 'public', table: 'bot_statistics', filter: 'bot_type=eq.frontrun' },
          (payload) => {
    ...
    const txChannel = supabase
      .channel('frontrun-transactions-updates')
      .on('postgres_changes', 
          { event: 'INSERT', schema: 'public', table: 'bot_transactions', filter: 'bot_type=eq.frontrun' },
          (payload) => {
  ...
  return (
    <div className="min-h-screen bg-crypto-darker text-foreground font-mono">
      ...
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-2xl mb-6 font-bold text-neon-yellow">Frontrun Bot Control</h1>
        ...
        <div className="mb-6">
          <BotLogsViewer botType="frontrun" />
        </div>
